...
- 架构文档：`architecture.md`（已随多存储实现更新，2026-08-27）
- 组件注册：`components/obsidian-plugin-s3-link.md`
- 设计决策：`decisions/2026-08-27-multi-cloud-storage-support.md`（**已实现**）
- 验证：`tsc` 类型检查、esbuild 构建、Jest（6 套件 / 35 用例）、ESLint 全部通过
